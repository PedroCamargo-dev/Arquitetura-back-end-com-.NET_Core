...
namespace curso.api.Controllers
{
    ...
    public class CursoController : ControllerBase
    {
        ...
        /// </summary>
        /// <response code="201">Sucesso ao cadastro um curso</response>
        [SwaggerResponse(statusCode: 201, description: "Sucesso ao cadastro um curso", Type = typeof(CursoViewModelInput))]
        ...
        /// </summary>
        /// <response code="200">Sucesso ao obter os curso</response>
